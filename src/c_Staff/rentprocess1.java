 ...
 * @author juls
 */
public class rentprocess1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 110, 30));

        jLabel1.setFont(new java.awt.Font("Georgia", 1, 16)); // NOI18N
        jLabel1.setBorder(new javax.swing.border.MatteBorder(null));
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, 410, 30));

        jLabel27.setFont(new java.awt.Font("Georgia", 0, 16)); // NOI18N
        jLabel27.setText("Total Price:");
        jPanel2.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 100, 30));

        totalamount.setFont(new java.awt.Font("Georgia", 1, 16)); // NOI18N
        totalamount.setBorder(new javax.swing.border.MatteBorder(null));
        jPanel2.add(totalamount, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 150, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 330, 120, 30));
        ...
        logout2.add(Save, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 9, 80, 20));
        ...
        jPanel2.add(returnDateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 330, 140, -1));
    ...
    int currentUid = session.getUserId();  
    // DEBUG: This will prove it's working in your console
    System.out.println("LOGGED IN ID: " + currentUid);
    if (rentDateChooser.getDate() == null || returnDateChooser.getDate() == null) {
        javax.swing.JOptionPane.showMessageDialog(null, "Please select both Rent and Return dates!");
        return;
    }
    ...
    if (rentDateChooser.getDate() == null) {
        JOptionPane.showMessageDialog(null, "Please select a rental date from the calendar!");
        return;
    }

  
    try {
        String insertSql = "INSERT INTO tbl_rentals (u_id, d_id, r_total, r_date, r_return, r_status, r_notes) "
                         + "VALUES (" + currentUid + ", '" + this.dressId + "', '" + this.dressPrice + "', "
                         + "'" + rDate + "', '" + retDate + "', 'Pending', '" + userNotes + "')";
        
        conf.addRecord(insertSql); 

        String updateSql = "UPDATE tbl_dresses SET d_status = 'Rented' WHERE d_id = '" + this.dressId + "'";
        conf.updateRecord(updateSql);

        JOptionPane.showMessageDialog(null, "Successfully Rented! User ID: " + currentUid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rentprocess1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rentprocess1().setVisible(true);
            }
        });
    }
