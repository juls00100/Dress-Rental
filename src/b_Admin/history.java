...
public class history extends javax.swing.JFrame {
    ...
    config conf = new config();
    // 1-Line SQL for the history table
    String sql = "SELECT r.r_id AS 'ID', r.r_cust_name AS 'CUSTOMER', d.d_name AS 'DRESS', r.r_total AS 'AMOUNT', r.r_transaction_date AS 'DATE' FROM tbl_rentals r JOIN tbl_dresses d ON r.d_id = d.d_id WHERE r.r_status IN ('Paid', 'Returned') ORDER BY r.r_id DESC";
    
    conf.displayData(sql, history_tbl); 
    config.styleTable(history_tbl);
}
    ...
    private void initComponents() {
        ...
        jPanel10.add(home, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 160, 40));
        ...
        history_tbl.setBackground(new java.awt.Color(255, 204, 255));
